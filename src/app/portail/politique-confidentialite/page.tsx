/**
 * /portail/politique-confidentialite — version pour locataire connecté.
 * v2.8.0 Vague 2.
 */
import { redirect } from 'next/navigation';
import { auth } from '@/auth';
import { prisma } from '@/lib/prisma';
import { buildPolitiqueConfidentialite } from '@/lib/legal-pages';
import LegalPageView from '@/components/LegalPageView';

export const dynamic = 'force-dynamic';

export default async function PortailPolitiquePage() {
  ...
  const sections = buildPolitiqueConfidentialite(loc.bien.bailleur);
  return (
    <LegalPageView
